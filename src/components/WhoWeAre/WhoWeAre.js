                ...
                <Container className="a-wwa-wrapper">
                        ...
                        <Row>
                            ...
                            <Col xs={12} md={6} sm={12}>
                                <div className="a-wwa-caption smallestText blackText b4 montserrat">
                                    ...
                                    <div>
                                        <Link to="/" className="a-wwa-readmore green b7 smallestText montserrat">Read more <img src={Forward} alt="forward"/></Link>
                                    </div>
                                </div>
                            </Col>
                        </Row> 
                    ...
                    <Row className="pt-4">
                        ...
                        <Col md={2} sm={8} className="a-wwa-sideline">
                            <div>
                                <p className="smallText b7 blackText montserrat">Find us on</p>
                                <span className="extraSmallText montserrat">
                                    <li>
                                        <a href="https://web.facebook.com/Aorthar/" target="blank">Facebook</a>                                
                                    </li>
                                    <li>
                                        <a href="https://www.instagram.com/aorthar/" target="blank">Instagram</a>
                                    </li>
                                    <li>
                                        <a href="https://twitter.com/aorthar" target="blank">Twitter</a>
                                    </li>
                                    <li>
